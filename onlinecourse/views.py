...
# <HINT> Create a submit view to create an exam submission for a course enrollment
...
# <HINT> A example method to collet the selected choices from the exam form from the request object
...
# <HINT> Create an exam result view to check if learner passed exam and show their question resuls and result for each question,
